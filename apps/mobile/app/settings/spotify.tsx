...
export default function SpotifyConnectionScreen() {
  ...
  const fetchIntegrations = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const spotify = data.find((i: { provider: string }) => i.provider === 'spotify');
        setConnectedService(spotify || null);
      }
    } catch (error) {
      console.error(error);
    } finally {
  ...
  useEffect(() => {
    if (url) {
      ...
      if (parsed.path === 'settings/spotify' || parsed.path === 'settings/spotify/callback') {
    ...
    <View style={styles.container}>
      ...
      {loading ? (
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.description}>Your ReelTune playlists will be synced to this Spotify account.</Text>
        ...
        <View style={styles.card}>
          <Text style={styles.description}>
            Connect your Spotify account to automatically sync your saved ReelTune playlists to Spotify.
          </Text>
          <TouchableOpacity 
